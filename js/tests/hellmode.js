...
function checkCollisionApple(deathBlockX,deathBlockY){
    return (deathBlockX >= (appleX - deathBlockwidthth / 2) && deathBlockX <= (appleX + deathBlockwidthth / 2)) && ((deathBlockY >= (appleY - deathBlockheightight * 2)) && deathBlockY <= (appleY + deathBlockheightight * 2));
}
